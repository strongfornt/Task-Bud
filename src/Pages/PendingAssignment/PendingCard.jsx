...
console.log(pdf.pdf)
  ...
  return (
	...
	<h2 className={`mb-4 text-2xl font-semibold leading-tight ${theme ==="light" ?'text-[#4b5664] ':'text-white'}`}> <span className="text-teal-500" >Pending</span> Assignment</h2>
    ...
    {
                    modal &&    <div className="relative z-50 flex justify-center">
                    ...
                    >
                      <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="relative inline-block p-4 overflow-hidden text-left align-middle transition-all transform border   shadow-xl sm:max-w-sm rounded-xl bg-gray-900 sm:my-8 sm:w-full sm:p-6">
                          <div className="flex items-center h-72 justify-center mx-auto">
                          <iframe src={pdf?.pdf} frameBorder="0" className="min-h-full" ></iframe>
                          </div>
                          ...
                          <div className="my-1">
                            ...
                            <div>
                            <label htmlFor="" className="text-white" >Quick Text Note</label>
                            <textarea
                              type="text"
                              name="note"
                              readOnly
